...
return [
    ...
    'documentations' => [
        'default' => [
            'documentation' => [
                'format' => 'yaml', // 👈 json ki jagah yaml
            ],
            'api' => [
            ...
            'paths' => [
                ...
                */
                 ...
                 */
                'annotations' => [
                    base_path('app/Schema/V1'),
                    base_path('app/Http/Controllers/Api/V1'),
                ],
                'exclude' => [
                    'api/profile',   // ya 'api/profile' depending on route
                ],
            ],
        ],
    ],
    'defaults' => [
        ...
        'scanOptions' => [
            'exclude' => [
                base_path('vendor'), // vendor folder skip karo
            ],
            /**
        ...
        */
        'securityDefinitions' => [
            'bearerAuth' => [ // change name if needed
                'type' => 'http',
                'scheme' => 'bearer',
                'bearerFormat' => 'JWT',
            ],
